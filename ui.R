...
# load('BDD_unificada.RData')
# load('Mapa.RData')
# load('ReporteNAs.RData')

# Colgar en Shinyapp.io -------------------------------------------
# rsconnect::setAccountInfo(name='cristianpachacama',
#                           token='C1B4566C1A8375604D0D8262D7A99617',
#                           secret='chMnwWU0K3ddwV9d75OrZJcswkbBNArkOgowP4G1')
#library(rsconnect)
#rsconnect::deployApp("C:/Users/TOSHIBA/Desktop/INTERFAZ-Proyecto Semilla/Proyecto_Interfaz_Usuario3")

#LINK de la aplicación -------
#https://cristianpachacama.shinyapps.io/proyecto_interfaz_usuario3/


# Define UI ========================================================
shinyUI(navbarPage("Proyecto Semilla",theme=shinytheme('flatly'),#theme = 'estilo.css',
                   footer = fluidRow(column(12,img(src='epn_logo.png',width='30px',align='center'),
                                            tags$b('Proyecto: '),' "Extreme low Levels of streamflow in Hydropower Plants"' ,
                                            '-',tags$a('EPN (2017)',href='http://www.epn.edu.ec'),
                                            tags$b('  ||  '),tags$b('Desarrollado por: '),
                                            tags$a('Cristian Pachacama',href='http://www.linkedin.com/in/cristian-david-pachacama')
                                            )
                                     ),
                   #footer=list(tags$hr(),tags$footer('Proyecto: Streamflows')),#position="fixed-top",
                   ...
                   navbarMenu("Datos",
                              ...
                              tabPanel('Buscar Estaciones (Mapa)',
                                       # sidebarPanel(
                                       #   #Este texto se debe Buscar en resum_NAs y mostrar todas las series encontradas
                                       #   textInput('txt_buscar', label= 'Escribe el Nombre de la Serie de Tiempo',value='CLIMA')
                                       # ),
                                       fluidRow(
                                                    ...
                                                    tabPanel('1. Descomposición STL',
                                                             fluidRow(
                                                               ...
                                                               sidebarPanel(h3('Descomposición STL-Loess'),
                                                                            ...
                                                                            # checkboxGroupInput('dsst_grp',label = 'Descomposicion LOESS',
                                                                            #                    choices = c('Serie Original','Tendencia',
                                                                            #                                'Estacionalidad','Ruido'),
                                                                            #                    selected = c('Serie Original','Tendencia',
                                                                            #                                 'Estacionalidad','Ruido')
                                                                            #                    
                                                                            # ),
